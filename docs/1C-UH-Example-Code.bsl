...
Процедура ЗаполнитьРеквизитыДокумента(ДокументОбъект, Данные)
	...
	Если Данные.Свойство("originalReceived") Тогда
		УстановитьРеквизитДокументаЕслиЕсть(ДокументОбъект, "ОригиналПолучен", Данные.originalReceived);
		УстановитьРеквизитДокументаЕслиЕсть(ДокументОбъект, "Оригинал", Данные.originalReceived);
	КонецЕсли;
	...
	Если Данные.Свойство("isUPD") Тогда
		...
		// Пробуем разные варианты имён реквизита
		...
		УстановитьРеквизитДокументаЕслиЕсть(ДокументОбъект, "ФормаДокумента", ?(ЗначениеУПД, "УПД", ""));
	КонецЕсли;
	...
	// Подразделение
	Если Данные.Свойство("department") И Не ПустаяСтрока(СокрЛП(Строка(Данные.department))) Тогда
		УстановитьРеквизитДокументаЕслиЕсть(ДокументОбъект, "Подразделение", Данные.department);
		УстановитьРеквизитДокументаЕслиЕсть(ДокументОбъект, "ПодразделениеОрганизации", Данные.department);
	КонецЕсли;
...
Процедура УстановитьРеквизитДокументаЕслиЕсть(ДокументОбъект, ИмяРеквизита, Значение)
	...
	Исключение
		...
		// Логирование убрано, чтобы не засорять журнал (можно включить при необходимости)
	КонецПопытки;
КонецПроцедуры
